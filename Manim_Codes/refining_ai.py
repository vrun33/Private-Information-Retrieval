...
class refining_ai(Scene):
    def construct(self):
        RefiningText = Tex(r"REFINING", color = BLUE).scale(1.3)
        RefiningText.to_edge(UP).center()
        self.play(Write(RefiningText), run_time=0.5)
        self.wait(2)

        NextFrameText = Tex(
            r"Consider the One-Time Pad",
            " Secret Sharing",
            r" method discussed earlier. We achieved a download rate of ",
            r"$\frac{1}{2}$", color = WHITE).scale(0.7)
        NextFrameText[1].set_color(ORANGE)
        NextFrameText[3].set_color(YELLOW)
        self.play(ReplacementTransform(RefiningText, NextFrameText), run_time=0.5)
        self.wait(5)

        NextFrame2 = Tex(
            r"Consider the PIR setting with ", "N=2",
            r" where a user wants to download a single file privately ," "out of a total of ", r"M=2 files.",
            color = WHITE).scale(0.7)
        NextFrame2[1].set_color(ORANGE)
        NextFrame2[3].set_color(YELLOW)
        self.play(ReplacementTransform(NextFrameText, NextFrame2), run_time=0.5)
        self.wait(0.8)
        self.play(FocusOn(NextFrame2[1]), run_time=0.5)
        self.wait(1)
        self.play(FadeOut(NextFrame2), run_time=0.5)
        self.wait(1)
        ...
        self.play(MoveToTarget(Text1), run_time=0.5)
        ...
        self.play(Write(NextText), run_time=0.5)
        self.wait(1)

        self.play(FadeOut(Text1), FadeOut(Text2), FadeOut(Text3), FadeOut(NextText), run_time=0.5)
        self.wait(1)
        ...
        self.play(Write(blistText), run_time=0.5)
        ...
        self.play(blistText.animate.shift(LEFT*2.5), run_time=0.5)
        self.play(Write(blist), run_time=0.5)
        self.wait(1)
        ...
        self.play(Write(InnerProduct1), Write(InnerProduct2), Write(Text4), Write(Text5), run_time=0.5)
        self.wait(3)
        ...
        self.play(MoveToTarget(TextGroup1), MoveToTarget(TextGroup2), run_time=0.5)

        DR = Tex(r"Download Rate for this scheme is ", r"$\frac{2}{3}$").scale(0.7)
        DR.move_to(DOWN*3)
        self.play(Write(DR), run_time=0.5)
        self.play(Indicate(DR[1]), run_time=0.5)

        self.play(FadeOut(Chart), FadeOut(blistText), FadeOut(blist), FadeOut(TextGroup1), FadeOut(TextGroup2), FadeOut(DR), run_time=0.5)
        self.wait(1)
        ...
        self.play(Write(NewText1), run_time=0.5)
        self.wait(1)
        ...
        self.play(Write(NewText5), run_time=0.5)
        self.wait(1)

        self.play(FadeOut(NewText1), FadeOut(NewText2), FadeOut(NewText3), FadeOut(NewText4), FadeOut(NewText5), run_time=0.5)
        self.wait(1)
        ...
        self.play(Write(NewNewText1), run_time=0.5)
        self.play(Circumscribe(NewNewText1[1]), run_time=0.5)
        self.wait(1)
        ...
        self.play(blistText2.animate.shift(LEFT*2.5), run_time=0.5)
        self.play(Write(blist), run_time=0.5)
        self.wait(1)
        ...
        Uhh.move_to(DOWN*3)
        Uhh[1].set_color(ORANGE)
        Uhh[4].set_color(ORANGE)
        self.play(Write(Uhh), run_time=0.5)
        self.play(Indicate(Uhh[1]), run_time=0.5)

        self.wait(2)
        self.play(FadeOut(Chart3), FadeOut(blistText2), FadeOut(blist), FadeOut(Uhh), run_time=0.5)
        self.wait(1)
        ...
        FinalText[2].set_color(ORANGE)
        FinalText[4].set_color(PURE_RED)
        self.play(Write(FinalText), run_time=0.5)
        self.play(Wiggle(FinalText[2]), Wiggle(FinalText[4]), run_time=0.5)
        self.wait(1)

        self.play(FadeOut(FinalText), run_time=0.5)
        self.wait(1)
